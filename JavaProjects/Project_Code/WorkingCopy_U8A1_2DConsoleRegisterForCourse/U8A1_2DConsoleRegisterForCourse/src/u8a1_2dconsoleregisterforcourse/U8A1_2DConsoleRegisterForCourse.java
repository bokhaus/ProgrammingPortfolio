...
public class U8A1_2DConsoleRegisterForCourse {
            ...
            switch (ValidateChoice(choice, validChoices, totalCredit, courses)) {
                ...
                case 0:
                    ...
                    if (validChoices[0][0].equals("")) {
                            ...
                            //***Created String 2D array to make compatiable
                            //***added correct values to array brackets 
    ...
    //***Added second [] to String to make a 2D array which corrected variable error in line 45 and lines 99 and 100.
    ...
    public static int ValidateChoice(int choice, String[][] validChoices, int totalCredit, String[][] courses) {
        ...
        if (choice < 1 || choice > 7)
            return -1;
                ...
                //*** lacked second set of [] made additional changes 
                //***by adding correct values to array column and row
                || choiceAsString.equals(validChoices[0][1]) 
    ...
    public static void WriteCurrentRegistration(String[][] validChoices, int totalCredit) {
        ...
        if (validChoices[0][0].equals(""))
            ...
            //***incorrect value to second bracket in array changed from i to 1
