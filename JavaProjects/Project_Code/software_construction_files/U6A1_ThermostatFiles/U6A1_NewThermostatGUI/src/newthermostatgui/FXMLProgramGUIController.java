 ...
 * @author User
 */
public class FXMLProgramGUIController implements Initializable {
    @FXML
...
public class UserSettings {//User Class for controlling Bufferedwriter
    ...
    public void getDay(String temp, String hour, String day){
        try {      
          Reader daySettings = 
            ...
            //Add popup ******** throws ERROR popup when not able to save
            Alert popOne = new Alert(Alert.AlertType.INFORMATION);
            popOne.setTitle("*** SYSTEM MESSAGE ***");
            popOne.setContentText("The temperature should could not be saved"); 
            popOne.setHeaderText("*** ERROR MESSAGE ***");
            popOne.show();     
