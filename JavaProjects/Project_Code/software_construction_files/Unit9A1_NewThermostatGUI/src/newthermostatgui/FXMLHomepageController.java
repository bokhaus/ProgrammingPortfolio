...
public class FXMLHomepageController implements Initializable {
    ...
    @FXML
    private void increaseTemp() { //Increase temp throw warning for temp limit
    ...
    @FXML
    private void decreaseTemp() {//Decrease temp throw warning for temp limit
    ...
    @FXML
    private void resetSetting() {//Set base temp of 70
        progSet.setTemp(70);
        currSett.setText(Integer.toString(progSet.getTemp()));
    }

    @FXML
    private void coolSetting() {//Set base cool of 50
        progSet.setTemp(50);
        currSett.setText(Integer.toString(progSet.getTemp()));
    }

    @FXML
    private void exitSystem() throws InterruptedException { //System Exit throws popup on exit
                //Add popup ******** 
            Alert popOne = new Alert(Alert.AlertType.INFORMATION);
        ...
        Platform.exit(); //Shutdown platform
        TimeUnit.SECONDS.sleep(2); //Pause 2 seconds prior to close
        System.exit(0); //Close program
    }
    @FXML
    public void handleButtonAction() throws Exception { //Get Json data for current status of Thermostat
        ...
        String pattern = "h:mm:ss a"; //set SimpleFormatted date as hour/minute/second pm
    ...
    @FXML //Temp button for Weekend screen
    private void goToWeekend(ActionEvent event) throws IOException {
