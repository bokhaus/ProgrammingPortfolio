...
public class Book {
    ...
    // Parameterized constructor, but grades not passed as parameter. See addGrade() below. 
    ...
    public void addReview(Date date, String book_rating, String review) {
        this.reviews.add(new Review(date, book_rating, review));
    }
